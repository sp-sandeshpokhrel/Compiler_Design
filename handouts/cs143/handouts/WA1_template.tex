...
% pdflatex -jobname=WA1_solved WA1_template.tex
% Upload WA1_solved.pdf to GradeScope
...
\begin{enumerate}
  ...
  % Problem 2
  % See Piazza post for how to generate DFAs using tikz
